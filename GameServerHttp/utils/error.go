...
var (
	...
	ErrConfig            = errors.New("configure error")
	ErrUnknown           = errors.New("unkonwn error")
	ErrParameter         = errors.New("parameter error")
	ErrFileNotFound      = errors.New("file not found")
	ErrOperation         = errors.New("operation error")
	ErrVerifyCode        = errors.New("verify code error")
	ErrDataRange         = errors.New("data out of range")
	ErrDataNotFound      = errors.New("data not found")
	ErrDataUpdate        = errors.New("data update error")
	ErrParse             = errors.New("parse error")
	ErrRequest           = errors.New("req error")
	ErrToken             = errors.New("token error")
	ErrRepeated          = errors.New("repeated error")
	...
	ErrAccountAvailable  = errors.New("account not available")
	ErrRedisNotKey       = errors.New("key not found")
	ErrDBNotRecord       = errors.New("record not found")
	ErrDisallowVoteSelf  = errors.New("disallow vote yourself")
	ErrDisallowReplySelf = errors.New("disallow reply yourself")
	ErrDisallowUpdate    = errors.New("disallow update")
	ErrAlreadyNodeId     = errors.New("snowflake nodeId is already in use")
)

// 错误处理
func HandleError(ctx *gin.Context, err error) {
	switch err {
	case ErrParameter, ErrVerifyCode, ErrAccountAvailable, ErrUserPassword:
		ctx.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
	case ErrFileNotFound, ErrDataNotFound, ErrUserNotFound:
